...
public final class ActivityEmployeeHomepageBinding implements ViewBinding {
  ...
  @NonNull
  public static ActivityEmployeeHomepageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityEmployeeHomepageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_employee_homepage, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityEmployeeHomepageBinding bind(@NonNull View rootView) {
